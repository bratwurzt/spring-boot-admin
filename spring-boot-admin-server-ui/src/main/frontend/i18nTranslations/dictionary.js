export const messages = {
  'en': {
    ...
    'custom.backup_endpoint.title': 'Backup',
    'custom.backup_endpoint.create_new_backup': 'Start new backup',
    'custom.backup_endpoint.start_restore': 'Restore',
    'custom.backup_endpoint.delete_backup': 'Cancel',
    'custom.backup_endpoint.restore.title': 'Restore',
    'custom.backup_endpoint.restore_in_progress': 'Restore in progress',
    'custom.backup_endpoint.restore_by_id': 'Restore backup by ID',
    'custom.backup_endpoint.restore_started': 'started at',
    'custom.backup_endpoint.workplans_left': 'work plans left',
    'custom.backup_endpoint.table.title.backupTimestamp': 'Time',
    'custom.backup_endpoint.table.title.status': 'Status',
    'custom.backup_endpoint.table.title.errorMsg': 'Error message',
    'custom.backup_endpoint.table.title.actions': 'Actions',
    'custom.backup_endpoint.table.content.status.IN_PROGRESS': 'In progress',
    'custom.backup_endpoint.table.content.status.COMPLETED': 'Completed',
    'custom.backup_endpoint.table.content.status.ERROR': 'Error',
    'custom.backup_endpoint.table.content.status.CANCELLED': 'Canceled',
  ...
  'ru': {
    ...
    'custom.backup_endpoint.title': 'Резервное копирование и восстановление',
    'custom.backup_endpoint.create_new_backup': 'Запустить новую резервную копию',
    'custom.backup_endpoint.start_restore': 'Восстановить',
    'custom.backup_endpoint.delete_backup': 'Удалить',
    'custom.backup_endpoint.restore.title': 'Восстановление',
    'custom.backup_endpoint.restore_in_progress': 'Восстановление в процессе',
    'custom.backup_endpoint.restore_by_id': 'Восстановить копию по идентификатору',
    'custom.backup_endpoint.restore_started': 'Время запуска',
    'custom.backup_endpoint.workplans_left': 'оставшихся планов',
    'custom.backup_endpoint.table.title.backupTimestamp': 'Временная метка',
    'custom.backup_endpoint.table.title.status': 'Статус',
    'custom.backup_endpoint.table.title.errorMsg': 'Сообщение об ошибке',
    'custom.backup_endpoint.table.title.actions': 'Действия',
    'custom.backup_endpoint.table.content.status.IN_PROGRESS': 'В процессе',
    'custom.backup_endpoint.table.content.status.COMPLETED': 'Выполненный',
    'custom.backup_endpoint.table.content.status.ERROR': 'Ошибка',
    'custom.backup_endpoint.table.content.status.CANCELLED': 'Отмененный',
